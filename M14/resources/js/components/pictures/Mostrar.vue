...
<div class="container">
    <section class="jumbotron text-center">
        <div class="container">
          ...
          <p>
            <router-link :to='{name:"crearCuadre", params: {id:1}}' class="btn btn-success">Crear</router-link>
            <router-link :to='{name:"EliminarShop"}' class="btn btn-danger">Incendiar</router-link>
          </p>
        </div>
      </section>

    <div class="album py-5 bg-light" v-for="picture in pictures" :key="picture.id">
        <div class="container">
